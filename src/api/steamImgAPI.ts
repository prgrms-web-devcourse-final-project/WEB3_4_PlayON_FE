 ...
 */
export const getHeader = async (gameId: string | number): Promise<string> => {
 ...
 */
export const getCapsule = async (gameId: string | number): Promise<string> => {
 ...
 */
export const getBackground = async (gameId: string | number, filtered: boolean = false): Promise<string> => {
