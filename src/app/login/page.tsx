...
#####      ################  ##### ######           #########  ######  ######`;
  ...
  return (
    <div className="bg-purple-900 text-purple-500 w-full h-full flex flex-col items-center">
      ...
      <div className="wrapper">
        <div className="mt-16 flex flex-col pb-10">
          ...
          <div className="font-dgm text-purple-500 mt-5 flex flex-col items-center dashed-border mb-10">
            <p className="text-4xl text-purple-500 font-dgm bg-purple-900 title">계정으로 로그인</p>
            <div className="flex flex-col gap-3 pb-8">
              <p className="font-dgm text-2xl">ENTER YOUR EMAIL</p>
              <Input className="border border-purple-500 rounded-none font-dgm text-lg" />
          ...
          <div className="font-dgm text-purple-500 mt-5 flex flex-col items-center dashed-border mb-10">
            <p className="text-4xl text-purple-500 font-dgm bg-purple-900 title">STEAM 인증으로 로그인</p>
          ...
          <div className="flex flex-col items-center">
            ...
            <Link href="/signup">
              <p className="font-dgm text-2xl glow">{`[ 회원 가입하러 가기 ]`}</p>
            </Link>
          </div>
        </div>
      </div>
