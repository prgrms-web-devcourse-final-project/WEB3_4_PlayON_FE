...
export default function PlayOnRollingBanner(props: { className: string }) {
  return (
    <RollingBanner
      className={`min-w-[3840px] flex-shrink-0 h-16 bg-gradient-to-r from-purple-700 to-purple-500 ` + props.className}
    >
