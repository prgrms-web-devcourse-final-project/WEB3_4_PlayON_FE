...
export default function EmptyLottie({ children, placeholder, className, imgWidth = 380 }: Props) {
  return (
    <div className={cn('relative text-center -translate-y-[18%] mx-auto', className)}>
      ...
      <div className="pl-8">
        <p className="font-dgm text-2xl text-purple-800">{placeholder || '플레이어님을 기다리고 있어요!'}</p>
        {children}
      </div>
    </div>
  );
